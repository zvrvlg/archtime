...
*Проект на ходится в разработке. Мы не скрываем статус: если вы видите баг — это нормально для текущей версии. Помогите нам сделать его лучше!*
## Демо: https://zvrvlg.github.io/archtime/
## О проекте
Современный PWA-планировщик задач с календарем. Работает как нативное приложение, но его можно установить!
